...
# MAGIC %sql
# MAGIC CREATE OR REFRESH LIVE TABLE customer
...
# MAGIC   LEFT JOIN LIVE.customer c
...
# MAGIC %sql
# MAGIC CREATE OR REFRESH LIVE TABLE fr_daily_customer_books
# MAGIC COMMENT "Daily number of books per customer in France"
# MAGIC AS
# MAGIC   SELECT customer_id, f_name, l_name, date_trunc("DD", order_timestamp) order_date, sum(quantity) books_counts
# MAGIC   FROM LIVE.orders_cleaned
